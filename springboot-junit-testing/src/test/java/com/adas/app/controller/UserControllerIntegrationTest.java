...
import com.adas.app.UserApplication;
import com.adas.app.controller.helper.HttpHelper;
...
public class UserControllerIntegrationTest {
    ...
    public void test_1_should_save_user()  {
        ...
        ResponseEntity<UserDto> response = testRestTemplate
        		.exchange(url, HttpMethod.POST, request, UserDto.class);
        //Then
    ...
    public void test_2_should_find_user_by_id() {
        ...
        //When
        ResponseEntity<UserDto> response = testRestTemplate
        	.exchange(url, HttpMethod.GET, request, UserDto.class);
